                ...
                <div class="cart-wizard-area">
                    ...
                    <div class="text">
                        ...
                        <div class="bottom-wizard d-flex justify-content-between align-items-center">
                            <p>
                                {{$details['price'] ? 'FCFA ' . $details['price'] : 'Free'}}
                                <span><del>{{$details['old_price'] ? 'FCFA' . $details['old_price'] : ''}}</del></span>
                            </p>
            ...
            <div class="col-lg-4">
                ...
                <div class="summery-wizard">
                    <div class="summery-wizard-text pt-0">
                        <h6>Subtotal</h6>
                        <p> {{'FCFA ' . number_format((float) session('cart_details')['cart_total'] , 2)}}</p>
                    </div>
                    <div class="summery-wizard-text">
                        <h6>Coupon Discount ({{session('cart_details')['discount'] ?? 0.00}}%)</h6>
                        <p>{{'FCFA ' . number_format((float) isset(session('cart_details')['discount_amount']) ? session('cart_details')['discount_amount']: 0.00 , 2)}}</p>
                    </div>
                    <div class="summery-wizard-text">
                        <h6>Taxes (15%)</h6>
                    ...
                    <div class="total-wizard">
                        ...
                        <p class="font-title--card">{{'FCFA ' . number_format((float) session('cart_details')['total_amount'] , 2)}}</p>
                    </div>
