                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$pc->price?'FCFA '.$pc->price:'Free'}}</span>
                                            <del>{{$pc->old_price?'FCFA '.$pc->old_price:''}}</del>
                                        </div>
                                    </div>
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$dc->price?'FCFA '.$dc->price:'Free'}}</span>
                                            <del>{{$dc->old_price?'FCFA '.$dc->old_price:''}}</del>
                                        </div>
                                    </div>
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$dv->price?'FCFA '.$dv->price:'Free'}}</span>
                                            <del>{{$dv->old_price?'FCFA '.$dv->old_price:''}}</del>
                                        </div>
                                    </div>
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$bc->price?'FCFA '.$bc->price:'Free'}}</span>
                                            <del>{{$bc->old_price?'FCFA '.$bc->old_price:''}}</del>
                                        </div>
                                    </div>
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$ic->price?'FCFA '.$ic->price:'Free'}}</span>
                                            <del>{{$ic->old_price?'FCFA '.$ic->old_price:''}}</del>
                                        </div>
                                    </div>
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
...
{{-- Why You'll Learn With EduVerse --}}
<section class="section feature section section--bg-offwhite-one">
    <div class="container">
        <h2 class="font-title--md text-center">Why You'll Learn with EduVerse</h2>
        <div class="row">
            ...
            <div class="col-lg-6 order-2 order-lg-0">
                <div class="learning-rules-starts">
                    <h2 class="font-title--md">
                        EduVerse Simple <br class="d-none d-md-block" />
                        Learning Steps
                    </h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="main-become-instructor-item ms-12 mb-0">
                    ...
                    <div class="main-text">
                        <h6 class="font-title--sm">Use EduVerse For Business</h6>
                        <p>
                            Praesent ultricies nulla ac congue bibendum. Aliquam tempor euismod purus posuere
                            gravida. Praesent augue sapien, vulputate eu imperdiet eget, tempor at enim.
                        </p>
                        <div class="text-center">
                            <a href="#" class="green-btn">Get EduVerse For Business</a>
                        </div>
                    </div>
                </div>
            </div>
