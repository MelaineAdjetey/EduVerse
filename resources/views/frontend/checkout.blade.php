                    ...
                    <div class="cart">
                            ...
                            <div class="productContent__wrapper">
                                ...
                                <div class="productContent">
                                    ...
                                    <div class="productContent-item__info productContent-item">
                                        ...
                                        <div class="price">
                                            <h6 class="font-para--md">{{$details['price'] ? 'FCFA ' . $details['price'] :
                                                'Free'}}</h6>
                                            <p><del>{{$details['old_price'] ? 'FCFA ' . $details['old_price'] : ''}}</del>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="cart__checkout-process">
                            <ul>
                                <li>
                                    <p>Subtotal</p>
                                    <p>{{'FCFA ' . number_format((float) session('cart_details')['cart_total'] , 2)}}
                                    </p>
                                    {{-- {{ 'FCFA ' . (session('cart_details') && array_key_exists('cart_total',
                                ...
                                <li>
                                    ...
                                    <p>{{'FCFA ' . number_format((float) isset(session('cart_details')['discount_amount']) ?
                                        session('cart_details')['discount_amount']: 0.00 , 2)}}</p>
                                </li>
                                <li>
                                    <p>Taxes (15%)</p>
                                    <p>{{'FCFA ' . number_format((float) session('cart_details')['tax'] , 2)}}</p>
                                    {{-- {{ 'FCFA ' . (session('cart_details') && array_key_exists('tax',
                                    session('cart_details')) ? number_format(session('cart_details')['tax'], 2) :
                                    '0.00') }} --}}
                                </li>
                                <li>
                                    <p class="font-title--card">Total:</p>
                                    <p class="total-price font-title--card">{{'FCFA ' .
                                        number_format((float)session('cart_details')['total_amount'] , 2)}}</p>
                                    {{-- {{ 'FCFA ' . (session('cart_details') && array_key_exists('total_amount',
